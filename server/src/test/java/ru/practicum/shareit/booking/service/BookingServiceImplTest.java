...
class BookingServiceImplTest {
    ...
    void testCreateBookingWithNonExistingOwner() throws Exception {
        ...
        assertEquals(String.format(NOT_EXISTING_USER, itemTestId), thrownException.getMessage());
    }
    ...
    void testCreateBookingWithUnavailable() throws Exception {
        ...
        assertEquals(String.format(UNAVAILABLE_ITEM, itemTestId), thrownException.getMessage());
    }
...
//                hasProperty("end", nullValue()),
    ...
    void testGetBookingByIdWithNotAuthorizedAccess() throws Exception {
        ...
        assertEquals(String.format(NOT_AUTHORIZED_ACCESS_TO_BOOKING, userTestId), thrownException.getMessage());
    }
    ...
    void testGetBookingByIdWithNotExistingBooking() throws Exception {
        ...
        assertEquals(String.format(NOT_EXISTING_BOOKING, bookingTestId), thrownException.getMessage());
    }
