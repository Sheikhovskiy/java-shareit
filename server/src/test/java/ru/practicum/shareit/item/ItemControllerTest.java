...
class ItemControllerTest {
    ...
    private static final String ITEM_DEFAULT_CREATE_RESPONSE = "{\"id\":1,\"name\":testItemName,\"description\":testDescription,\"available\":true,\"request\":null,\"requestId\":3}";

    private static final String ITEM_DEFAULT_WITH_COMMENT_RESPONSE = "{\"id\":1,\"name\":testItemName,\"description\":testDescription,\"available\":true,\"comments\":null,\"lastBooking\":null,\"nextBooking\":null}";

    private static final String ITEM_DEFAULT_COMMENT_RESPONSE = "{\"id\":1,\"text\":\"commentTestText\",\"authorName\":testUserName,\"created\":null}";
...
//        itemUpdateDto.setId(itemTestId);
    ...
    void testGetItemById() throws Exception {
        ...
        mockMvc.perform(get(path))
                .andExpect(status().isOk())
                .andExpect(content().json(ITEM_DEFAULT_WITH_COMMENT_RESPONSE));
    ...
    void testCreateComment() throws Exception {
        ...
        mockMvc.perform(post(path)
                ...
                .andExpect(status().isOk())
                .andExpect(content().json(ITEM_DEFAULT_COMMENT_RESPONSE));
