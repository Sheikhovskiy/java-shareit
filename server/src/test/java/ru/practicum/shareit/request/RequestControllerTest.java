...
class RequestControllerTest {
    ...
    private static final String REQUEST_DEFAULT_RESPONSE = "{\"id\":1,\"description\":requestTestDescription,\"created\":null,\"items\":null}";
    ...
    void init() {
        ...
        requestTest.setName(requestTestName);
    ...
    void testCreateRequest() throws Exception {
        ...
        mockMvc.perform(post("/requests")
                ...
                .andExpect(content().json(REQUEST_DEFAULT_RESPONSE));
