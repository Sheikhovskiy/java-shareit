...
class RequestServiceImplTest {
    ...
    private final static Request EXPECTED_DEFAULT_REQUEST = new Request();

    private final static Request EXPECTED_DEFAULT_EXISTING_DATA_REQUEST = new Request();
    ...
    void init() throws Exception {
        ...
        //
        EXPECTED_DEFAULT_REQUEST.setId(1L);
        EXPECTED_DEFAULT_REQUEST.setDescription("requestDescriptionTest");

        //
        EXPECTED_DEFAULT_EXISTING_DATA_REQUEST.setId(11L);
        EXPECTED_DEFAULT_EXISTING_DATA_REQUEST.setDescription("requestFirstDescription");
        EXPECTED_DEFAULT_EXISTING_DATA_REQUEST.setCreated(null);
        EXPECTED_DEFAULT_EXISTING_DATA_REQUEST.setOwner(userTest);
    }
    ...
    void testCreateRequest() throws Exception {
        ...
        RequestInfoDto requestInfoDtoExpected = makeRequestInfoDto(EXPECTED_DEFAULT_REQUEST);
    ...
    void testGetAllRequestsByUserId() throws Exception {
        ...
        RequestInfoDto requestInfoDtoExpected = makeRequestInfoDto(EXPECTED_DEFAULT_EXISTING_DATA_REQUEST);
    ...
    void testGetRequestByIdWithNotExistentRequestId() {
        ...
        assertEquals(String.format(NOT_EXISTING_REQUEST, requestTestId), thrownException.getMessage());
    }
