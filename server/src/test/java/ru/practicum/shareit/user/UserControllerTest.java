...
class UserControllerTest {
    ...
    private final static String USER_DEFAULT_RESPONSE = "{\"id\":1,\"email\":\"userTest@Email\",\"name\":\"userTestName\"}";

    private final static String USER_DEFAULT_DELETE_RESPONSE = "{\"email\":\"userTest@Email\",\"name\":\"userTestName\"}";
    ...
    void testCreateUser() throws Exception {
        ...
        mockMvc.perform(post("/users")
                ...
                .andExpect(content().json(USER_DEFAULT_RESPONSE));
    ...
    void testDeleteUserById() throws Exception {
        ...
        mockMvc.perform(delete(path))
                .andExpect(status().isOk())
                .andExpect(content().json(USER_DEFAULT_DELETE_RESPONSE));
