...
public class BookingController {
    ...
    @PostMapping
    public BookingInfoDto createBooking(@RequestHeader(HEADER_USER_ID) long bookerId,
    ...
    public BookingInfoDto updateBooking(@RequestHeader(HEADER_USER_ID) long ownerId,
                                        @PathVariable long bookingId,
                                        @RequestParam(name = "approved") boolean approvment) {

        log.info("Получен ответ на бронирование предмета по идентификатору {} от пользователя с идентификатором {} " +
    ...
    public BookingInfoDto getBookingById(@RequestHeader(HEADER_USER_ID) long userId,
                                         @PathVariable long bookingId) {
    ...
    @GetMapping
    public List<BookingInfoDto> getAllBookingsByUserId(@RequestHeader(HEADER_USER_ID) long userId,
    ...
    public List<BookingInfoDto> getAllBookingsOfOwner(@RequestHeader(HEADER_USER_ID) long userId,
