...
public class BookingMapper {
    ...
    public static BookingInfoDto toBookingInfoDtoFromBooking(Booking booking) {
    ...
    public static List<BookingInfoDto> toListBookingInfoDtoFromListBooking(List<Booking> bookingList) {
    ...
    public static Booking toBookingFromBookingCreateDto(BookingCreateDto bookingCreateDto) {
